<template>
  <div>
    ...
    <div class="container mt-3">
      <b-input-group size="md" class="mb-3" :prepend="$t('create-game-p')">
        <b-form-input
          @keyup.enter="newGame"
          v-model="newGameName"
          :placeholder="$t('game-name')" trim></b-form-input>
        <b-input-group-append>
          <b-button
            v-b-tooltip.hover :title="$t('create-game')"
            @click="newGame"
            variant="success">
